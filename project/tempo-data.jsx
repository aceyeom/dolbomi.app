// tempo-data.jsx — shared data + icon set for all TEMPO home-screen skins.
// Attaches everything to window.TEMPO so each babel script can read it.
...
TEMPO.icon = function (key, { size = 20, color = 'currentColor', stroke = 1.8 } = {}) {
  const p = {
...
TEMPO.navIcon = function (key, { size = 24, color = 'currentColor', stroke = 1.8 } = {}) {
