// tempo-ui.jsx — TEMPO design foundation.
...
if (!document.getElementById('tempo-tokens')) {
  ...
  .tempo[data-theme="light"][data-pal="gold"]{
  ...
  .tempo[data-theme="light"][data-pal="green"]{
  ...
  .tempo[data-theme="light"][data-pal="steel"]{
  ...
  .tempo{ background:var(--bg); }
  .tempo *{ scrollbar-width:none; box-sizing:border-box; }
  .tempo *::-webkit-scrollbar{ display:none; }
  .tempo .mono{ font-family:var(--mono); font-variant-numeric:tabular-nums; }
  .tempo .num{ font-variant-numeric:tabular-nums; letter-spacing:-.02em; }
  /* ── motion ── */
  ...
  .tempo h1,.tempo h2,.tempo h3,.tempo p{margin:0;}
  `;
