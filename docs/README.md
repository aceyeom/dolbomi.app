...
- 🔄 **Phase 2 (진행 중)** — 웨이브 단위.
  ...
  - ✅ Wave 1d: 나머지 기능 문서 심화 — 코어루프([01](./01-core-loop.md))·스탯([02](./02-stats.md))·혜택허브([05](./05-benefits-hub.md))·리퍼럴([06](./06-referral-engine.md))·결산([07](./07-monthly-recap.md))·데이터모델([08](./08-data-models.md))에 약점/리스크·수학·스키마·미해결질문 추가. (웹 불필요, Opus)
  - ⏳ Wave 1c: 나머지 시드 3개(정보처리 C1·한국사 C3·TOEIC C4) — **WebSearch 쿼터 소진(리셋 18:40 UTC)으로 인용 검증 대기** ([PHASE2_RESUME.md](../PHASE2_RESUME.md)).
  - ⏳ Wave 2: 신규 기회 **~10개** breadth (Sonnet 에이전트, **기존 카테고리 파일로 병합**) — 동일 쿼터 사유로 대기.
